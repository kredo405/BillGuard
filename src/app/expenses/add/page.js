        ...
        <div className="space-y-5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 sm:text-base text-gray-900 pr-10" // Added pr-10 for icon
              value={category}
              onChange={(e) => setCategory(e.target.value)}
            />
            <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" /> {/* Icon */}
